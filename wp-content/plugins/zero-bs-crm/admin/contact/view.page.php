...
function zeroBSCRM_pages_admin_display_clientportal_tab($id=-1){
  ...
  global $zbs;
        ...
        if ($wp_user_id != -1 && $wp_user_id > 0){
            ...
            $html .= '<div class="ui segment center aligned">';
            $html .= '<h4 class="ui header">' . __('Email address required','zero-bs-crm') . '</h4>';
            $html .= __('Add an email to this contact to enable Customer Portal functionality',"zero-bs-crm") . '<br /><br />';
              $html .= '<a href="' . zbsLink('edit',$zbsCustomer['id'],ZBS_TYPE_CONTACT) . '" class="ui small primary button button-primary">';
              $html .= __('Edit Contact','zero-bs-crm');
              $html .= '</a>';
            $html .= '</div>';
