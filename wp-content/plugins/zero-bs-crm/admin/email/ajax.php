...
function zeroBSCRM_send_email_thread_ajax(){
  ...
  // send
  jpcrm_send_single_email_from_box( $send_to_email, $thread_id, $delivery_method, true );
...
*/
function jpcrm_send_single_email_from_box( $send_to_email = '', $thread_id = -1, $delivery_method = -1, $exit_json = true ){
