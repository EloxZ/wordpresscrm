...
if (isset($zbsLicenseClaimed)){
    ...
    echo zeroBSCRM_UI2_messageHTML('info',__('API Key Notice','zero-bs-crm'),sprintf( __( 'Thank you for entering your API key. This key has been successfully associated with this install. If you would like to change which domain uses this API key, please go <a href="%s">here</a>.', 'zero-bs-crm' ), $zbs->urls['account'] ) );
}
##/WLREMOVE
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                ...
                <td style="width:540px">
                    <input style="padding:10px;" name="wpzbscrm_license_key" id="wpzbscrm_license_key" class="form-control" type="text" value="<?php if (isset($licenseKeyArr['key']) && !empty($licenseKeyArr['key'])) echo $licenseKeyArr['key']; ?>" />
                </td>
            </tr>
