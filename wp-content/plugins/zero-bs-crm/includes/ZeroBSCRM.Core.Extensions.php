...
$zeroBSCRM_extensionsCompleteList = array(
	...
	'woosync' => array(
		...
		'fallbackname' => 'WooCommerce Connect', # This is if no name func is found... 
		'desc' => __('Retrieve all customer data from WooCommerce.',"zero-bs-crm"),
		'url' => 'https://jetpackcrm.com/product/woocommerce-connect/',
		'colour' => 'rgb(216, 187, 73)',
		'helpurl' => 'https://kb.jetpackcrm.com/article-categories/woocommerce-connect/'
