...
/* ======================================================
   ...
   ====================================================== */
	...
	function zeroBSCRM_migration_notice_1119() {
	    ...
	    <div class="updated notice is-dismissable">
	        ...
	        $ver = '1.1.19'; printf( esc_html__( 'Jetpack CRM has completed a necessary migration to version %s. Thanks for using Jetpack CRM.', 'zero-bs-crm' ), $ver );
	        ?></p>
	    </div>
	    <?php
	} 
	...
	function zeroBSCRM_migration_notice_123() {
	    ...
	    <div class="updated notice is-dismissable">
	        ...
	        $ver = '1.2.3'; printf( esc_html__( 'Jetpack CRM has completed a necessary migration to version %s. Thanks for using Jetpack CRM.', 'zero-bs-crm' ), $ver );
	        ?></p>
	    </div>
	    <?php
	} 
	...
	*/
	...
	function zeroBSCRM_migration_notice_127() {
	    ...
	    <div class="updated notice is-dismissable">
	        ...
	        $ver = '1.2.7'; printf( esc_html__( 'Jetpack CRM has completed a necessary migration to version %s. Thanks for using Jetpack CRM.', 'zero-bs-crm' ), $ver );?></p>
	    </div>
	    <?php
	} 
	...
	*/
	...
	function zeroBSCRM_migration_notice_216() {
	    ...
	    <div class="updated notice is-dismissable">
	        ...
	        $ver = '2.16'; printf( esc_html__( 'Jetpack CRM has completed a necessary migration to version %s. Thanks for using Jetpack CRM.', 'zero-bs-crm' ), $ver );
	        ?></p>
	    </div>
	    <?php
	} 
	...
	*/
	...
	function zeroBSCRM_migration_notice_22() {
	    ...
	    <div class="updated notice is-dismissable">
	        ...
	        $ver = '2.20'; printf( esc_html__( 'Your CRM has completed a necessary migration to version %s.', 'zero-bs-crm' ), $ver );
	        ?></p>
	    </div>
	    <?php
	} 
	...
	*/
	...
	function zeroBSCRM_migration_notice_227() {
	    ...
	    <div class="updated notice is-dismissable">
	        ...
	        $ver = '2.27'; printf( esc_html__( 'Your CRM has completed a necessary migration to version %s.', 'zero-bs-crm' ), $ver );
	        ?></p>
	    </div>
	    <?php
	} 
	...
	*/
	...
	function zeroBSCRM_migration_notice_240() {
	    ?>
	    <div class="updated notice is-dismissable">
	        <p><?php echo sprintf( __( 'Your CRM has completed a necessary migration to version %s.', 'zero-bs-crm' ), '2.40' ); ?></p>
	    </div>
	    <?php
	} 
	...
	*/
	...
	function zeroBSCRM_migration_notice_241() {
	    ?>
	    <div class="updated notice is-dismissable">
	        <p><?php echo sprintf( __( 'Your CRM has completed a necessary migration to version %s.', 'zero-bs-crm' ), '2.41' ); ?></p>
	    </div>
	    <?php
	} 
	...
	*/
	...
	function zeroBSCRM_migration_notice_242() {
	    ?>
	    <div class="updated notice is-dismissable">
	        <p><?php echo sprintf( __( 'Your CRM has completed a necessary migration to version %s.', 'zero-bs-crm' ), '2.42' ); ?></p>
	    </div>
	    <?php
	} 
	...
	*/
	...
	function zeroBSCRM_migration_notice_250() {
	    ?>
	    <div class="updated notice is-dismissable">
	        <p><?php echo sprintf( __( 'Your CRM has completed a necessary migration to version %s.', 'zero-bs-crm' ), '2.50' ); ?></p>
	...
	*/
	...
	function zeroBSCRM_migration_notice_2531() {
	    ?>
	    <div class="updated notice is-dismissable">
	        <p><?php echo sprintf( __( 'Your CRM has completed a necessary migration to version %s.', 'zero-bs-crm' ), '2.53.1' ); ?></p>
	    </div>
	    <?php
	} 
	...
	function zeroBSCRM_migration_notice_280() {
	    ?>
	    <div class="updated notice is-dismissable">
	        <p><?php echo sprintf( __( 'Your CRM has completed a necessary migration to version %s.', 'zero-bs-crm' ), '2.80' ); ?></p>
	    </div>
	    <?php
	} 
	function zeroBSCRM_migration_notice_280_fail() {
	    ?>
	    <div class="updated notice is-dismissable">
	        <p><?php echo sprintf( __( 'Your CRM was unable to complete a necessary migration to version %s.', 'zero-bs-crm' ), '2.80' ); _e('You may need to manually create your email templates. If this does not work, please contact support.','zero-bs-crm'); ?></p>
	    </div>
	    <?php
	} 
	...
	*/
	...
	function zeroBSCRM_migration_notice_281() {
	    ?>
	    <div class="updated notice is-dismissable">
	        <p><?php echo sprintf( __( 'Your CRM has completed a necessary migration to version %s.', 'zero-bs-crm' ), '2.81' ); ?></p>
	    </div>
	    <?php
	} 
	...
	*/
	function zeroBSCRM_migration_270(){
		...
		// now req by core :) require_once( ZEROBSCRM_INCLUDE_PATH . 'ZeroBSCRM.Migrations.Database.php');
	...
	function zeroBSCRM_migration_notice_270() {
	    ...
	    ?>
	    <div class="updated notice is-dismissable">
	        <p><?php echo sprintf( __( 'Your CRM contact database was successfully migrated. Please update any <a href="%s" target="_blank">PRO Extensions</a> you may have installed.', 'zero-bs-crm' ), $zbs->urls['products'] ); ?></p>
	    </div>
	    <?php
	}
...
*/
	...
	*/
	...
	function zeroBSCRM_migration_notice_287() {
	    ?>
	    <div class="updated notice is-dismissable">
	        <p><?php echo sprintf( __( 'Your CRM has completed a necessary migration to version %s.', 'zero-bs-crm' ), '2.87' ); ?></p>
	    </div>
	    <?php
	} 
	...
	*/
	...
	function zeroBSCRM_migration_notice_2943() {
	    ?>
	    <div class="updated notice is-dismissable">
	        <p><?php echo sprintf( __( 'Your CRM has completed a necessary migration to version %s.', 'zero-bs-crm' ), '2.94.3' ); ?></p>
	...
	*/
	...
	function zeroBSCRM_migration_notice_295() {
	    ...
	    ?>
	    <div class="updated notice is-dismissable">
	        <p><?php echo sprintf( __( 'Your CRM has completed a necessary migration to version %s.', 'zero-bs-crm' ), '2.95' ); ?></p>
...
DROP INDEX `zbsset_key`;";
	...
	function zeroBSCRM_migration_notice_300() {
	    ...
	    ?>
	    <div class="updated notice is-dismissable">
	        <p><?php echo sprintf( __( 'Your CRM database was successfully migrated. Please update any <a href="%s" target="_blank">PRO Extensions</a> you may have installed.', 'zero-bs-crm' ), $zbs->urls['products'] ); ?></p>
	    </div>
	    <?php
	}
	...
	function zeroBSCRM_migration_308(){
		...
		if ($shouldBeInstalled == "1"){
	        ...
	        #} install pdf fonts 
			require_once( ZEROBSCRM_INCLUDE_PATH . 'ZeroBSCRM.PDFBuilder.php');
	...
	function zeroBSCRM_migration_smtp_passwords() {
		...
		if ( ! function_exists(' zeroBSCRM_encryption_unsafe_process' ) ) {
			require_once( ZEROBSCRM_INCLUDE_PATH . 'ZeroBSCRM.Encryption.php' );
		}
	...
	function zeroBSCRM_migration_450(){
		...
		foreach ( $directories as $directory ){
			jpcrm_secure_directory_from_external_access( $directory );
		}

		// mark complete
		zeroBSCRM_migrations_markComplete('450',array('updated'=>1));
  ...
  function zeroBSCRM_page_contactMigrationDB2() {
    ...
    switch ($stage){
      ...
      case 0:
        ...
        ?><div class="ui very padded segment">
          ...
          <div class="ui divider"></div>
          <p><strong><?php _e('NOTE: If you use the CRM API, or a sync extension, for adding contacts, it is important you run this routine in one sitting.',"zero-bs-crm"); ?></strong></p>
          <div class="ui divider"></div>
          <p style="text-align:center">
              <a href="<?php echo $zbs->urls['db2migrate']; ?>" target="_blank" class="ui large button basic"><?php _e('Read Guide',"zero-bs-crm"); ?></a>
    ...
    jQuery(function(){
      ...
      if (window.zbsDBMigrationStage === 1){
        ...
        jQuery('#zbs-dbmigration-stop').off('click').on( 'click', function(){
        ...
        jQuery('#zbs-dbmigration-resume').off('click').on( 'click', function(){
  ...
  function zeroBSCRM_page_migrationDB3() {
    ...
    // ================================================================================
		    ...
		    if (!zeroBSCRM_isWL()){
		            ...
		            $logo = '<img src="'.ZEROBSCRM_URL.'i/jpcrm-logo.png" class="zbs-feedback-logo" alt="" />';
		            ...
		            $obj = array(
		                            ...
		                            'fail' => zeroBSCRM_slashOut(__('Failed sending feedback! Please try again, or open a support ticket:','zero-bs-crm').' <a href="' . $zbs->urls['support'] . '" target="_blank">'.__('Contact support','zero-bs-crm').'</a>',true),
          ...
          <?php
          	...
          	if (is_array($errors) && count($errors) > 0){
                ...
                // this is a clone of what gets sent to them by email, but reusing the html gen here
					...
					$bodyStr .= '<p>'.__('You can review these errors at a later time by visiting CRM Settings -> System Assistant -> System Status -> Migration Errors (at bottom of page) or by bookmarking','zero-bs-crm').' <a href="'.zeroBSCRM_getAdminURL($zbs->slugs['systemstatus']).'&tab=status&v3migrationlog=1" target="_blank">'.__('this link','zero-bs-crm').'</a>.</p>';
    ...
    jQuery(function(){
    	...
    	if (window.zbsDBMigrationStage === 1){
    		...
    		// bind submit
    		jQuery('#zbs-start-v3-migration').off('click').on( 'click', function(){
