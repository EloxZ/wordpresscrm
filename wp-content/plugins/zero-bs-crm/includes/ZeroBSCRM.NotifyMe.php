...
function zeroBSCRM_notifyme_echo_type($type = '', $title = '', $sender = -999, $content = ''){
  ...
  global $zbs;
    ...
    case 'extension.update':
      ##WLREMOVE
        echo __("🔔 [URGENT] Your extension(s) need updating ","zero-bs-crm").'<a href="'.$zbs->urls['account'].'" target="_blank">'.__("Click here to retrieve the new versions","zero-bs-crm").'</a>. '.__("(If you don't know your login, please", "zero-bs-crm").' <a href="'.$zbs->urls['support'].'" target="_blank">'.__('Email Support',"zero-bs-crm").'</a>.)';
      ##/WLREMOVE
        break;
