...
function zeroBSCRM_updates_v4AvailUpdateNotice( $data, $response ) {
    ...
    $msg = '</p><div style="background-color:#D0E6B8;padding:0.5em 1em;margin: 1em"><strong>'.__('ZBS CRM is now Jetpack CRM.','zero-bs-crm').'</strong> - '.__('Once you update this plugin it will be called `Jetpack CRM` instead of `Zero BS CRM`.','zero-bs-crm');
...
function zeroBSCRM_updates_v3AvailAdminNotice(){
    ...
    ?>
        <div id="updated" class="error notice is-dismissible">
            <p><?php 
            echo '<p><strong>Jetpack CRM '.__('is ready to update to v3.0.','zero-bs-crm').'</strong></p><div style="margin:1em">'.__('This update requires a database upgrade which may take 5-10 minutes, please do not update until you are ready to migrate!','zero-bs-crm');
